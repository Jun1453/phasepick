...
class SeismicData():
    ...
    #                                 if True:
    #                                     # stations_matching = download_inventory(client, f"{self.respdir}/{self.network_code}.{self.station_code}", network=network, station=station, starttime=starttime)[0][0]
